    ...
    public static <T> void setAdapter(View view, T[] values, Function<T, String> extractor) {
        if (view instanceof AutoCompleteTextView) {
            ((AutoCompleteTextView) view).setAdapter(
                    new ArrayAdapter<String>(view.getContext(), R.layout.default_dropdown_menu_popup_item, com.vinga129.savolax.ui.retrofit.rest_objects.groups.enumToStrings(values, extractor)));
        }
    }
