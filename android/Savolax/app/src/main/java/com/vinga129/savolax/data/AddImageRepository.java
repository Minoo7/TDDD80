...
public class AddImageRepository {
    ...
    public Single<Result<Integer>> uploadImage(Context context, Bitmap bitmap) {
    ...
    private static class AddImageDataSource {
        ...
        public static Single<Result<Integer>> uploadImage(MultipartBody.Part body) {
        ...
        private static Single<Result<Integer>> parseResult(Map<String, String> responseMap) {
            return Single.just(new Result.Success<Integer>(
